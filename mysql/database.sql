...
create table usuarios(ID int not null primary key auto_increment, usuario varchar(50) not null,contraseña varchar(200) not null, nombre varchar(50) not null,
